...
function Header() {
  return (
    <header className="flex py-5 sm:py-10  md:py-20 px-2 sm:px-4 justify-around flex-wrap sm:gap-7 miniphon:gap-7">
      ...
      <div className=" bg-ImgHead rounded-full p-6 relative miniphon:h-[300px] miniphon:w-[300px] sm:h-[350px] sm:w-[350px] md:h-[350px] md:w-[350px] xl:h-[526px] xl:w-[526px] lg:h-[400px] lg:w-[400px]">
        <div className="bg-ImgHeadBG miniphon:h-12 miniphon:w-12 xl:h-20 xl:w-20 h-16 w-16 rounded-full flex justify-center absolute bottom-[55px] left-2 xl:bottom-[75px] xl:left-7">
          <img className="w-3/4" src={reactLogo} alt="react logo" />
        </div>
        <div className="bg-ImgHeadBG miniphon:h-12 miniphon:w-12 xl:h-24 xl:w-24 h-16 w-16 rounded-full flex justify-center absolute bottom-[55px] xl:bottom-[75px] miniphon:right-1 right-2">
          <img className="w-3/5" src={javaScriptLogo} alt="javaScript logo" />
        </div>
        <div className="bg-ImgHeadBG miniphon:h-12 miniphon:w-12 xl:h-20 xl:w-20 h-16 w-16 rounded-full flex justify-center absolute miniphon:right-4 right-8 xl:right-16">
